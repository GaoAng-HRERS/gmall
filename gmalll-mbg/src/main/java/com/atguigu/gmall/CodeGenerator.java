...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("E:\\练习文件\\workspace\\idea\\gmall-parent\\gmalll-mbg" + "/src/main/java");
        gc.setAuthor("GA");
        ...
        dsc.setUrl("jdbc:mysql://192.168.1.106:3307/gmall_"+moduleName+"?useUnicode=true&useSSL=false&characterEncoding=utf8");
